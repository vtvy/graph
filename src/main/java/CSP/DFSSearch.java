...
public class DFSSearch
{
	...
	{
//		//     System.out.print("Checking frequency for:\n"+qry.getListGraph());
...
//		{
////			//     System.out.print("Minimum variable size is less than the threshold, and it is: "+min);
//			return;
//		}
		...
		for (int i = variables.length-1; i >=0 ; i--) 
		{
			...
			if(Settings.isAutomorphismOn && atm.hasAutomorphisms())
			{
				...
				if(i!=preIndex)
				{
					search=false;
//					if(Settings.PRINT)
//						//     System.out.print("it has automorphisms");
...
//			if(min<minFreqThreshold)
//			{
////				//     System.out.print("[Fast check] Minumum variable size is less than the threshold, and it is: "+min);
//				return;
//			}
			...
			for (Iterator<myNode> iterator = firstList.values().iterator(); iterator.hasNext();)
			{
				...
				{
					if(Settings.PRINT)
						//     System.out.print("ALready searched before !!");
					continue;
				}
...
//					if(Settings.PRINT)
						//     System.out.print("ERRRRRRRRRRRRRRRRRRR........................................Not Found: ");
				}
				if(value==-1)
				{
...
//						break;
					...
					if(Settings.PRINT)
					//     System.out.print("ERRRRRRRRRRRRRRRRRRR........................................Value: "+value);	
			...
			if(result[index].getList().size()<minFreqThreshold)
			{
				...
				{
					//     System.out.print("less than the threshold, and it is: "+(result[index].getList().size()+tmp.size()));
					return;
				}
				if(Settings.isApproximate==true)
				{
...
//								break;
				...
				else //TRULY SEARCH INTO IT!!
				{
					...
					for (int j = 0; j < tmp.size(); j++) 
					{
						if((result[index].getList().size()+(tmp.size()-j))<minFreqThreshold)
						{
							//     System.out.print("less than the threshold, and it is: "+result[index].getList().size()+(tmp.size()-j));
							return;
						}
...
//								break;
	...
	private void printVariablesSize(Variable[] vars)
	{
		...
		{
			     System.out.print("Var["+i+"]"+vars[i].getList().size());
		}
	}
